...
>
	<div class="flex md:flex-col flex-row items-stretch w-full">
		<!-- thumbnail -->
		<img
			src={project.thumbnail}
			alt={project.title}
			class="bg-cover max-h-96 rounded-t-md dark:bg-black bg-slate-400 p-1 mb-4 order-2 md:order-1 w-full"
		/>
