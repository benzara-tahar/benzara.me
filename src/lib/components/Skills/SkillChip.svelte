...
>
	<img
		class="w-10 h-10 p-1 transition bg-cover rounded-full max-w-none dark:bg-slate-900 bg-slate-300 group-hover:bg-primary-500"
		alt={skill.name}
		src={skill.image}
	/>
	<span class="p-2 text-gray-700 dark:text-gray-200 ">
		{skill.name}
	</span>
</span>
